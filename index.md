...
<dl>
  ...
  <dd class="abstract-toggle">
    <details>
      <summary>Abstract</summary>
      <p>I ask whether Federal Reserve balance-sheet policy has the same effect on real GDP and the price level when different liabilities finance it. I develop HARS-Z, a sampler that imposes zero restrictions alongside the shock heteroskedasticity, sign restrictions, and narrative restrictions of HARS (Kim and Zha, 2026). On monthly U.S. data I identify two balance-sheet shocks, one financed by reserves and one by overnight reverse repurchases (ON RRP). At the 90% level the reserve-financed contraction lowers GDP, and the ON RRP-financed contraction lowers the GDP deflator. The reserve-financed shock contributes a median &minus;3.9 percent to the unexpected change in GDP over the first quantitative tightening. Every contribution of the ON RRP-financed shock has a 90% interval that includes zero. Local projections on the identified shocks reach the first links of the money channel. The reserve-financed contraction lowers bank deposits and raises the funds spread over interest on reserves. The ON RRP-financed contraction moves neither.</p>
    </details>
  </dd>
</dl>
